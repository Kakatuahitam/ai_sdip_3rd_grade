...
![Yes, not too complex but drawing something is time consuming, that's why there is Background Illustrator](../_static/images/content/11/backdrop-code-1.png)

![This is what a Backdrop Illustrator draws](../_static/images/content/11/backdrop-code-2.png)
```
...
![Wanna hear the video game sound? Find the button to play the sound!](../_static/images/content/11/audio-composer-1.png)

![This is snoring sound!](../_static/images/content/11/audio-composer-2.png)
```
